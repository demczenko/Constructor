...
export function Footer(sections, options) {
  ...
  const json_footer = {
                ...
                <tr>
                    <td>
                        <a href="${href}?utm_source=newsletter&utm_medium=email&utm_campaign=${id}">
                            <img loading="lazy" src="${src}" width="610" style="display: block; max-width: 100%;">
                        </a>
                    </td>
                </tr>
                <tr>
                ...
                <table class="newsletterContainer" cellspacing="0" cellpadding="0" border="0" align="center" style="background-color: #ffffff;" id="newsletter">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a href="${href}?utm_source=newsletter&utm_medium=email&utm_campaign=${id}">
                                <img loading="lazy" src="${src}" style="display: block; max-width: 100%;">
                                </a>
                            </td>
                        </tr>
                        <tr>
    ...
    socials: {
      [types.NEWSLETTER]: {
        value: ({ title, instagram, facebook, youtube, pinterest }) => {
          return `
            <table class="newsletterContainer" cellspacing="0" cellpadding="0" border="0" align="center" style="background-color: #ffffff;">
            <tbody>
                <tr>
  ...
  //                             }</font></b>
  //                             <br />${companyDetails.address}<br />${
  //       companyDetails.mobileNumber
  //     } ${companyDetails.emailAddress}
  //                             <a href="${companyDetails.mailTo}">${
  //       companyDetails.email
  //     }</a>
  //                             <br />${companyDetails.commercialRegister}<br />${
  //       companyDetails.vat
  //     }
  //                         </span>
  //                     </td>
  ...
  for (const section in sections) {
    ...
    if (section in json_footer) {
      if (!("exclude" in elem)) {
        html += json_footer[section][options.type].value(elem);
        continue;
      }
      if (!elem.exclude) {
        html += json_footer[section][options.type].value(elem);
