          ...
          <tbody>
              ...
              <tr>
                <td align="center" style="background-color: #ffccb7;" class="newsletterContainer">
                  ${Paragraph(queries.intro, "center", "color: #ff2f00")}
                  </td>
              </tr>
              ...
              <tr>
                <td style="padding-top: 0px; padding-left: 0px; padding-right: 0px; text-align: center; background-color: #ffccb7;">
                  <a href="${origin}" style="color:#ff2f00; text-decoration: underline;">
      ...
      <table align="center" border="0" cellpadding="0" cellspacing="0" class="newsletterContainer" style="margin: 0 auto; max-width: 650px; color: #000000; background-color:#ffffff;" id="newsletter">
          <tbody>
                          ...
                          <tr>
                            ...
                            <tr>
                                <td align="left" class="newsletterBottom35px">
                                    <span class="newsletterSoonEndingTitle">${getField(queries.templates, "Shop limited-time deals")}</span>
                                </td>
                            </tr>
                            <tr>
              ...
              ${
                ...
                <tr>
                  <td>
                    <a href="${getField(queries.footer, "Asembly href")}">
      ...
      ${Footer(
        {
          ...
          conditions: {
            ...
            conditionsText: [getField(queries.templates, "Conditions Regular"), getField(queries.templates, "Unsubscribe message")],
          },
          companyDetails: {
