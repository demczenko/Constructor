...
initApp({
  ...
  // serverHeader: true,
  token:
    "1//04wiRRNIe1s1NCgYIARAAGAQSNwF-L9IrQ9bbz44zSqXn7qLYM_mUeirCc3qHap-6aoiKVqfJryFXOX_C7FcN0nVe4ophmTOWmJ4",
  tableQueries: [
    {
      tableId: "15hF-nbul3ZtRqoMiIxI15Ez5lGhee1gUeM3njz5ixtE",
      tableName: "Voucher - 18.12.23 - Bathroom set for free",
      tableRange: "18:26",
      name: "tables",
    },
    {
  ...
  newsletterLinks: [
    ...
    {
      value: (country) =>
        `https://beliani.info/newsletter/2022/${country}231208.png`,
    },
  ],
  landingLinks: [
    {
